...
public class MyController {
	...
	public String homePage(ModelMap model){
		model.addAttribute("myvalue", "kolido");
		return "a_cout";
	}
	...
	public String saveProfile(@Valid Employee employee, BindingResult result, ModelMap model) {
		if (result.hasErrors()) {
			return "employee";
		}
	...
	public String displayAbout(ModelMap model){
		model.addAttribute("intro", "im yuh, my love is mok");
		return "about";
	}
}